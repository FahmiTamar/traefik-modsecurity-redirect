...
- [Traefik Modsecurity Redirect](#traefik-modsecurity-redirect)
  - [Demo](#demo)
...
* `redirectUrl`: (**mandatory**) it's the URL for redirection if thread detected.
